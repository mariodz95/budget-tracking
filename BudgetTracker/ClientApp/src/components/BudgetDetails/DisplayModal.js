    ...
    <>
      <Modal show={props.show} onHide={props.handleClose}>
          ...
          <Form >
              <Form.Group as={Row} controlId="formHorizontalNote">
                  <Form.Label column sm={2}>
                    ...
                    <Col sm={5}>
                        <Form.Control type="text" placeholder="Note" onChange={e => props.setTransactionNote(e.target.value)}/>
                    </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} controlId="formHorizontalValue">
                    ...
                    <Col sm={5}>
                        <Form.Control type="text" placeholder="Value" onChange={e => props.setIncomeValue(e.target.value)}/>
                    </Col>
              </Form.Group>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" className="create-wallet-button" onClick={props.createTransaction}>
            Save Changes
          </Button>
        </Modal.Footer>
      </Modal>
